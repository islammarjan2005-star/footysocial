...
export const validGuesses: Set<string> = new Set([
  ...answers,
  // More footballer surnames (5 letters)
  'SCHAR', 'TARIQ', 'WHITE', 'YOUNG', 'TERRY', 'TERRY', 'GIGGS', 'ROBYN',
  'ROONY', 'HENRY', 'VIEIRA', 'PETIT', 'PIRES', 'DIABY', 'SAGNA', 'KOLO',
  'TOURE', 'SILVA', 'BARRY', 'MILNE', 'HART', 'DZEKO', 'TEVEZ', 'YAYA',
  'AGUERO', 'NASRI', 'CLICHY', 'LESCA', 'ZABAL', 'FERDI', 'VIDIC', 'BROWN',
  'PARK', 'GIGGS', 'NANI', 'YOUNG', 'WELBK', 'JONES', 'SMALE', 'EVANS',
  'CLEVE', 'DEFOE', 'CROUC', 'ZAMOR', 'DAWSO', 'HUDDL', 'LENNON', 'MODRI',
  'BALE', 'SPURS', 'WALKER', 'ROSE', 'MASCH', 'LAMELA', 'CHADL', 'PAULIN',
  'ERIKSEN', 'ALLI', 'WINKS', 'DIER', 'SISSOK', 'AURIE', 'TRIPP', 'LLORIS',
  'LUCAS', 'MOURA', 'LOREN', 'NDOMB', 'GLICK', 'DOHRT', 'REGUIL', 'VINICIU',
  // More common 5-letter surnames
  'SMITH', 'JONES', 'BROWN', 'DAVIS', 'EVANS', 'LLOYD', 'MOORE', 'CLARK',
  'BAKER', 'GREEN', 'ADAMS', 'ALLEN', 'SCOTT', 'MILLS', 'STONE', 'GRANT',
  'WOODS', 'HENRY', 'MARSH', 'HAYES', 'KELLY', 'REYES', 'CESAR', 'LUCAS',
  'MARIO', 'DIEGO', 'PABLO', 'JORGE', 'LUIS', 'CARLOS', 'ANGEL', 'OSCAR',
  'BRUNO', 'MARCO', 'PAULO', 'FABIO', 'ANDRE', 'RUBEN', 'DAVID', 'ALVARO',
  // Famous footballer surnames
  'ZIDAN', 'RONNY', 'PUYOL', 'XAVI', 'INIESTA', 'BUSQU', 'PIQUE', 'ALBA',
  'PEDRO', 'VILLA', 'FABRE', 'SANCH', 'NEYM', 'SUARE', 'RAKITIC', 'UMTIT',
  'DEMBELE', 'COUT', 'ARTHU', 'VIDAL', 'GRIEZM', 'LENGL', 'DEST', 'BRAITHW',
  'ANSU', 'FATI', 'PEDRI', 'GAVI', 'ARAUJO', 'KOUNDE', 'CHRIS', 'BALDE',
  // Premier League players
  'RICE', 'SAKA', 'ODEGA', 'JESUS', 'ZINCH', 'TOMIY', 'WHITE', 'SALIBA',
  'GABRI', 'MARTI', 'TROSS', 'SMITH', 'ROWE', 'NKETIAH', 'VIEIRA', 'JORGINHO',
  'HAALAND', 'FODEN', 'RODRI', 'STONE', 'DIAZ', 'WALKER', 'AKANJI', 'AKER',
  'GREALISH', 'BERNARDO', 'KOVAC', 'ORTEGA', 'EDERSON', 'NUNEZ', 'DIAZ', 'JOTA',
  'GAKPO', 'SZOBOS', 'MAC', 'ALLISTER', 'ENDO', 'GRAVEN', 'TSIM', 'QUANS',
  // More valid guesses
  'TONEY', 'WISSA', 'MBEUM', 'HENRY', 'RAYA', 'FLEKK', 'AJER', 'MEPHAM',
  'PINNOCK', 'JANSS', 'NORGD', 'ONYEKA', 'DAMSGRD', 'SCHAR', 'BURN', 'TRIPP',
  'TARGT', 'BOTMN', 'LASCL', 'KRAFT', 'ISAK', 'ALMIR', 'JOELINTON', 'GUIMRZ',
  'WILCK', 'LONG', 'MURPH', 'BRUNO', 'TONALI', 'GORDO', 'BARNES', 'LIVEL',
  'MADDISON', 'SOYUN', 'NDIDI', 'TIELEMANS', 'FAES', 'VESTERG', 'CASTAGNE',
  'DAKA', 'VARDY', 'IHEANA', 'PEREZ', 'SOUMARE', 'PRAET', 'DEWSB', 'HALL',
]);
